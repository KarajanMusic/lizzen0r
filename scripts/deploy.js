...
if (!argv.network || (argv.network !== 'ganache' && argv.network !== 'kovan')) {
    console.log('Please specify a valid Ethereum network: --network= (ganache / kovan)'.red);
    process.exit(1);
}
...
const web3MainNet = new web3(new web3.providers.HttpProvider(constants.networks[argv.network].endpoint));
